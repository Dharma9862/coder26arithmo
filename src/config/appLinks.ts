...
export const MORE_APPS_CATALOG: FeaturedAppItem[] = [
  ...
  },
  {
    ...
    rating: 4.7,
    icon: '🧠',
    description: 'Daily cognitive agility, spatial reasoning, and working memory micro-workouts.',
    url: 'https://play.google.com/store/apps/details?id=com.numbersprint.brainzen',
  },
  {
    id: 'logic_grid',
    name: 'LogicGrid Aptitude & Puzzles',
    category: 'Puzzles & Logic',
    rating: 4.9,
    icon: '🧩',
    badge: 'Featured',
    description: 'Quantitative analytical reasoning, seating arrangements, and syllogisms.',
    url: 'https://play.google.com/store/apps/details?id=com.numbersprint.logicgrid',
  },
];
